...
function BootstrapAccordion() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-12 lg:gap-12">
      {/* LEFT PANEL */}
      <div className="lg:col-span-4">
        <div className="rounded-[28px] border border-white/20 bg-white/15 p-6 md:p-8 backdrop-blur-xl">
      ...
      {/* RIGHT PANEL */}
      <div className="lg:col-span-8">
        <div className="rounded-[28px] border border-white/20 bg-white/15 px-5 md:px-8 backdrop-blur-xl">
          {items.map((item, idx) => {
            const isOpen = idx === openIndex;
